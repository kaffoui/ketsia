                        ...
                        <div class="hero-content mx-auto w-100 h-100 d-flex flex-column">
                            <div class="row no-gutters">
                                <div class="col-10 col-lg-9 mx-auto">
                                    <div class="logo mt-2 mb-5 mb-md-0"> <a class="d-flex" href="/"
                    ...
                    <div class="container my-4">
                        <div class="row">
                            <div class="col-11 col-lg-9 col-xl-8 mx-auto">
                                <h4 class="font-weight-400 mb-4">Réinitialisation de mot de passe</h4>
                                <form id="" method="post" action="{{route('resetPassword')}}">
                                    @csrf
                                    ...
                                    <button class="btn btn-primary btn-block my-4" type="submit">Réinitialiser</button>
                                    <p class="text-3 text-center text-muted"><a class="btn-link"
